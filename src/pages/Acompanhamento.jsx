...
export default function Acompanhamento() {
  ...
  const obterDescricaoStatus = (status) => {
    if (status === 'pendente') {
      return 'Sua solicitação foi recebida e está na fila de acolhimento da equipe de assistência social.'
    }

    if (status === 'em_atendimento') {
      return 'Seu atendimento foi iniciado. Mantenha a página de atendimento aberta para participar da chamada.'
    }

    if (status === 'em_acompanhamento') {
      return 'Seu atendimento inicial foi realizado. Agora você pode acompanhar mensagens, documentos e próximos passos do caso.'
    }
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-[#111f1a] border border-[#1e3b2e] rounded-3xl p-6">
            ...
            <div className="space-y-3">
              <div className="border border-[#1e3b2e] rounded-2xl p-4 bg-[#0d1f1a]">
